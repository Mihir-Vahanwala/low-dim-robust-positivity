...
We justify the inability of our techniques to generalise to LRS of higher order by establishing a connection to a number-theoretic hurdle: that of Diophantine Approximation. Diophantine Approximation is a vast and active number-theoretic field of research, one of whose concerns is the approximation of reals by rational numbers. A key tool in this regard is the partial fraction expansion $[0; a_1, a_2, \dots]$ of an irrational $t \in (0, 1)$:
$$
...
We apply the density theorem as follows.
\begin{lemma}
