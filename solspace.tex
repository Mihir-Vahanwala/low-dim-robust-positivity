...
For any order $\kappa$ LRS $\seq{\mathbf{a}, \mathbf{c}}$, the $n^{th}$ term $u_n$ has the following closed form, consisting of $\kappa$ monomials:
\begin{equation}
\label{eq:exppoly}
